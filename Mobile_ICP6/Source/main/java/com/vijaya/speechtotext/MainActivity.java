                ...
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        ...
                        if(result.get(0).equalsIgnoreCase("hello")) {
                            ...
                            tts.speak("Sorry, I can understand. Please tell your symptoms in short.", TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">Speaker : Sorry, I can understand. Please tell your symptoms in short.</p>"));
                        }
